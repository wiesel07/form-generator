...
public class GenUtils {
	...
	public static void generatorCode(TableInfo tableInfo, List<TableField> tableFields, ZipOutputStream zip) {
	 ...
	 * 获取文件名
	 */
	private static String getFileName(String template, TableInfo tableInfo, GeneratorProperties generatorProperties) {
...
//			return packagePath + File.separator + "service" + File.separator + "impl" + File.separator + serviceImplName
//					+ ".java";
//		}
//
...
//			return packagePath + File.separator + "controller" + File.separator + "req" + File.separator + reqEntityName
//					+ ".java";
//		}
//
//		// html
...
//			jsPrefix += File.separator + "static" + File.separator + "js" + File.separator + "app" + File.separator
//					+ moduleName;
...
//			return htmlPrefix + File.separator + classname + File.separator + classname + ".html";
//		}
//
//		if (template.contains("add.html.vm")) {
//			return htmlPrefix + File.separator + classname + File.separator + "add.html";
//		}
//		if (template.contains("edit.html.vm")) {
//			return htmlPrefix + File.separator + classname + File.separator + "edit.html";
//		}
//
//		// js
//		if (template.contains("list.js.vm")) {
//			return jsPrefix + File.separator + classname + File.separator + classname + ".js";
//		}
//
//		if (template.contains("add.js.vm")) {
//			return jsPrefix + File.separator + classname + File.separator + "add.js";
//		}
//
//		if (template.contains("edit.js.vm")) {
//			return jsPrefix + File.separator + classname + File.separator + "edit.js";
//		}
//
...
//		}
	...
	private static VelocityContext getVelocityContext(GeneratorProperties generatorProperties, TableInfo tableInfo,
	...
	// 生成渲染表的信息
	private static TableInfo getTableInfo(GeneratorProperties generatorProperties, TableInfo tableInfo,
			List<TableField> tableFields) {
	...
	private static IColumnType processTypeConvert(String fieldType) {
